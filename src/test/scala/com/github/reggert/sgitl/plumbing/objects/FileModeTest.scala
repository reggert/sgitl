...
class FileModeTest extends Suite with ShouldMatchers
{
	...
	{
		FileMode.Tree.unapply("40000") should equal (Some(FileMode.Tree))
	...
	{
		FileMode.AsString.unapply("40000") should equal (Some(FileMode.Tree))
	...
	{
		FileMode.AsBytes.unapply(UTF8("40000")) should equal (Some(FileMode.Tree))
